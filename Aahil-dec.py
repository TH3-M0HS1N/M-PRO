...
__author__ = 'Mr-Mohsin'
__copyright = 'All rights reserved . Copyright  Mr-Mohsin'
...
{_ {__   {___  {__    {__  {__     {__{__    {__{__{_ {__   {__
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/TH3-M0HS1N/M-PRO/main/server.text').text
    if to in r:
